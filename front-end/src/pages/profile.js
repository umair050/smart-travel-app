...
<TouchableOpacity onPress={()=>navigation.navigate('currencyconvertor')}>
<Card style={styles.mycard}>
    <View style={styles.cardcontent}>
    <FontAwesome name="exchange" size={32} color="#04555c"/>
    <Text style={styles.mytext}>currencyconvertor</Text>
    </View>
</Card>
</TouchableOpacity>
